...
function SF_scripts() {
  ...
  if (
    $(".header_8 .slider").length > 0 &&
    $(".header_8 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".header_19 .slider").length > 0 &&
    $(".header_19 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".content_22 .slider").length > 0 &&
    $(".content_22 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".content_23_slider").length > 0 &&
    $(".content_23 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".content_27 .slider").length > 0 &&
    $(".content_27 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".content_29 .slider").length > 0 &&
    $(".content_29 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".content_31 .slider").length > 0 &&
    $(".content_31 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".feature_29 .slider").length > 0 &&
    $(".feature_29 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".feature_31 .slider").length > 0 &&
    $(".feature_31 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".form_4 .slider").length > 0 &&
    $(".form_4 .slider").hasClass("slick-initialized") === false
  ) {
    $(".form_4 .slider").slick({
      slidesToShow: 1,
      slidesToScroll: 1,
  ...
  if (
    $(".form_15 .slider").length > 0 &&
    $(".form_15 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".pricing_table_6 .slider").length > 0 &&
    $(".pricing_table_6 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".ecommerce_11 .slider").length > 0 &&
    $(".ecommerce_11 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".ecommerce_15 .slider").length > 0 &&
    $(".ecommerce_15 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".ecommerce_19 .slider").length > 0 &&
    $(".ecommerce_19 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".ecommerce_32 .slider").length > 0 &&
    $(".ecommerce_32 .slider").hasClass("slick-initialized") === false
  ) {
  ...
  if (
    $(".ecommerce_35 .slider").length > 0 &&
    $(".ecommerce_35 .slider").hasClass("slick-initialized") === false
  ) {
